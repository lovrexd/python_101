...
``` python
Nepoznati podatak za vrijeme izvršavanja programalisting:nepoznati_podatak text = input("Unesi tekst i pritisni <enter>: ") print(text) input("Pritisni <enter> za kraj")
```
